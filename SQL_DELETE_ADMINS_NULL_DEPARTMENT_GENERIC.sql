-- ============================================
-- Script: Delete Admins with Null Department (Generic Version)
-- ============================================
-- This version uses only email and department_id (most common columns)
-- Run SQL_CHECK_ADMINS_TABLE_STRUCTURE.sql first to see your table structure

-- STEP 1: Check current state - See which admins have NULL department
-- Using only email and department_id (these should exist in most tables)
SELECT 
